    ...
    experience: [
        ...
        },
        {
            ...
            projects: [
                ...
                {
                    name: "NMS Apps — Enterprise HRIS Platform",
                    tagline: "One platform, three domains: HR, Attendance, and Payroll & Finance.",
                    technologies: [
                        "Laravel 10",
                        "PHP 8.1",
                        "React.js 18",
                    ...
                    details: [
                        "Core developer and maintainer of the company-wide HRIS serving the entire organization — a single Laravel + React monolith split into three business domains: HR, Attendance, and Payroll & Finance.",
                        "Architected shared foundations used by all three domains: role- and permission-based access control, OAuth SSO, queued jobs, Redis caching, and a reusable Excel/PDF report-export layer.",
                        "Integrated AI and workflow automation into the platform through assistant modules, an n8n client API, and Telegram-based notification delivery.",
                    ],
                    modules: [
                        {
                            name: "Human Resources",
                            details: [
                                "Built employee 201 file management, company directory, departments, sections, ranks, and job-title settings.",
                                "Developed an organizational chart, employee grouping with tags, and dynamic custom form fields so HR can extend employee records without code changes.",
                                "Implemented leave credits, special and monetized leaves, offenses, policies, and document mailing with configurable templates.",
                                "Added a help desk, knowledge base, patch notes, and patient chart module, plus full activity and user-log auditing.",
                                "Designed the employee database schema and enforced secure handling of sensitive personnel data.",
                            ],
                        },
                        {
                            name: "Attendance & Timekeeping",
                            details: [
                                "Built biometric/RFID time-log ingestion that processes raw device logs into validated attendance records through queued jobs.",
                                "Developed roster and schedule management with bulk upload and export, plus timesheets, breaksheets, tardiness, and overbreak tracking.",
                                "Implemented filing and approval flows for overtime, rest-day work, leaves, suspensions, AWOL, and NCNS cases.",
                                "Created a cut-off automation pipeline that closes, recomputes, and unlocks attendance periods on schedule.",
                                "Wrote a time-log validator with automated Telegram and email notifiers to flag missing or malformed logs before payroll runs.",
                                "Added IP whitelisting and off-premise time-log detection to catch out-of-office punches.",
                            ],
                        },
                        {
                            name: "Payroll & Finance",
                            details: [
                                "Built the payroll computation engine covering gross pay, night differential, overtime, rest-day, and holiday pay — including strict timezone handling for holiday overtime and rest-day boundaries.",
                                "Implemented statutory Philippine contributions and reporting: SSS, PhilHealth, Pag-IBIG/HDMF, and BIR withholding tax with versioned contribution tables.",
                                "Developed 13th-month pay, last-pay/final-pay computation, payroll adjustments, and payroll movement reporting.",
                                "Built the loan module end to end — loan types, settings, amortization schedules, max-loanable rules, signature prerequisites, and a dedicated loan-status page with Telegram notifications.",
                                "Delivered payslip generation with automated Telegram payslip distribution, payday scheduling, and annual/comparative-year summaries.",
                                "Produced government-mandated and internal reports with Excel and PDF export pipelines for finance and audit use.",
                            ],
                        },
                    ],
                },
